...
public class ExpLabelPreview extends Exp {
    public static void main(String args[]) throws Exception {
        ...
        if (args.length != 2) {
            System.out.println("Usage: java -cp PanelSegJ.jar ExpLabelPreview <Sample List File> <target folder>");
            System.out.println("	This is a utility program to generate imageColor preview of label rects.");
            System.exit(0);
        }
    ...
    {
        generatePreview(PreviewType.ORIGINAL);
        generatePreview(PreviewType.NORM64);
    }

    /**
     * Generate original label preview
     */
    void generatePreview(PreviewType type)
    {
