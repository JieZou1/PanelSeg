    ...
    for anchor_size_idx in range(len(anchor_sizes)):
        for anchor_ratio_idx in range(n_anchratios):
            ...
            for ix in range(output_width):
                ...
                # ignore boxes that is at least half outside of the original image boundaries
                # if x1_anc < 0 or x2_anc > resized_width:
                # continue
                x_mid = (x1_anc + x2_anc) / 2
                if x_mid < Figure.PADDING or x_mid > resized_width - Figure.PADDING:
                    continue
                ...
                for jy in range(output_height):
                    ...
                    #     continue
                    y_mid = (y1_anc + y2_anc) / 2
                    if y_mid < Figure.PADDING or y_mid > resized_height - Figure.PADDING:
                        continue
                    ...
                    for bbox_num in range(num_bboxes):
                        ...
                        if img_data['bboxes'][bbox_num]['class'] != 'bg':
                            ...
                            # if the IOU is >0.3 and <0.6, it is ambiguous and no included in the objective
    ...
    while True:
        ...
        for img_data in all_img_data:
            try:
                ...
                try:
                    y_rpn_cls, y_rpn_regr = calc_rpn(c, img_data_aug, width, height, width, height,  # resized_width, resized_height,
