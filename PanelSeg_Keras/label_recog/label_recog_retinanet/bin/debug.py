...
def parse_args(args):
    ...
    parser.add_argument('--dataset_type', help='We always use CSV only',
                        default='csv')
    parser.add_argument('--annotations_file', help='Path to CSV file containing annotations for evaluation.',
                        default='/Users/jie/projects/PanelSeg/programs/PanelSeg_Keras/label_recog/label_recog_retinanet/exp/PanelSeg/eval.csv')
    parser.add_argument('--classes_file',     help='Path to a CSV file containing class label mapping.',
