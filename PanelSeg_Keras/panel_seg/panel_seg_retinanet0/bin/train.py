...
# Change these to absolute imports if you copy this script outside the panel_seg_retinanet package.
...
def parse_args(args):
    """ Parse the arguments.
    """
    parser = argparse.ArgumentParser(description='Training script for Panel Segmentation with RetinaNet.')
