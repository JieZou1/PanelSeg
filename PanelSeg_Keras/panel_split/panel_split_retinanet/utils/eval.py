...
def evaluate(
    ...
    aps = eval_average_precisions(generator, generator.num_classes(), all_detections, all_annotations, iou_threshold)
    prs = eval_precision_recall(generator, generator.num_classes(), all_detections, all_annotations, iou_threshold)
